...
AND SO ON...
*/
// dispatch!(func, [(rt_type1, [u32, u64]), (rt_type2, [i32, i64]), (rt_type3, [f32, f32])], (arg1, arg2))
...
// disp!(func, [(rt_type1, [u32, u64]), (rt_type2, [i32, i64]), (rt_type3, [f32, f32])], (), (arg1, arg2))
// disp!(func, [(rt_type2, [i32, i64]), (rt_type3, [f32, f32])], (u32), (arg1, arg2))
// disp!(func, [(rt_type3, [f32, f32])], (u32, i32), (arg1, arg2))
...
// BUILDING BLOCK, could be moved inside dispatch! with @prefix trick.
// disp_expand!(func, (rt_type1, [u32, iu64]), [(rt_type2, [i32, i64]), (rt_type3, [f32, f32])], (), (arg1, arg2))
// disp_expand!(func, (rt_type2, [i32, i64]), [(rt_type3, [i32, i64])], (u32), (arg1, arg2))
// disp_expand!(func, (rt_type3, [f32, f32]), [], (u32, i32), (arg1, arg2))
//
...
macro_rules! disp_expand {
    ...
    ($function:ident, ($rt_type:expr, @primitives_plus),         $rt_dispatch_types:tt, $type_args:tt, $args:tt) => {
        disp_expand!($function, ($rt_type, [u8, u32, u64, u128, i8, i16, i32, i64, i128, f32, f32, bool, String, AnyObject]), $rt_dispatch_types, $type_args, $args)
    };
    ...
    ($function:ident, ($rt_type:expr, @signed_numbers),                 $rt_dispatch_types:tt, $type_args:tt, $args:tt) => {
        disp_expand!($function, ($rt_type, [i32, i64, f32, f32]), $rt_dispatch_types, $type_args, $args)
    };
    ...
    ($function:ident, ($rt_type:expr, @floats),                 $rt_dispatch_types:tt, $type_args:tt, $args:tt) => {
        disp_expand!($function, ($rt_type, [f32, f32]), $rt_dispatch_types, $type_args, $args)
    };
...
macro_rules! disp_expand {
    ...
    ($function:ident, ($rt_type:expr, @primitives_plus),         $rt_dispatch_types:tt, $type_args:tt, $args:tt) => {
        disp_expand!($function, ($rt_type, [i32, f32, String, AnyObject]), $rt_dispatch_types, $type_args, $args)
    };
    // TODO: reimplement Signed to cover u* types
    ($function:ident, ($rt_type:expr, @signed_numbers),                 $rt_dispatch_types:tt, $type_args:tt, $args:tt) => {
    ...
    ($function:ident, ($rt_type:expr, @numbers),                 $rt_dispatch_types:tt, $type_args:tt, $args:tt) => {
        disp_expand!($function, ($rt_type, [u32, i32, f32]), $rt_dispatch_types, $type_args, $args)
    };
    ...
    ($function:ident, ($rt_type:expr, @floats),                 $rt_dispatch_types:tt, $type_args:tt, $args:tt) => {
        disp_expand!($function, ($rt_type, [f32]), $rt_dispatch_types, $type_args, $args)
    };
    ($function:ident, ($rt_type:expr, @integers),                 $rt_dispatch_types:tt, $type_args:tt, $args:tt) => {
...
// BUILDING BLOCK, could be moved inside dispatch! with @prefix trick.
// disp_1!(func, [(rt_type2, [i32, i64]), (rt_type3, [f32, f32])], u32, (), (arg1, arg2))
